...
const Sidebar: FC<sidebarProps> = ({ logout }) => {
    return (
        <div className="min-h-full p-3 space-y-2 w-64 text-grey-70 bg-grey-11 backdrop-blur-lg flex-grow">

            <div className="divide-y divide-gray-300 flex flex-col justify-between">
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                    <li className="bg-green-60 text-gray-900">
                    ...
                    <li>
                        <div className="flex items-center p-2 space-x-3 rounded-md">
                            ...
                            <span className="hover:cursor-pointer">Chat</span>
                        </div>
                    </li>
                    <li>
                        <div className="flex items-center p-2 space-x-3 rounded-md">
                    ...
                    <li>
                        <div className="flex items-center p-2 space-x-3 rounded-md">
                            ...
                            <span className="hover:cursor-pointer">Wishlist</span>
                        </div>
                    </li>
                </ul>
