...
import HeroSection from "@/components/User/HeroSection1"
...
const HomePageUser = () => {
    ...
    useEffect(() => {
        const fetchNowShowingMoviesList = async () => {
            try {
                const response = await axiosInstance.get("/user/nowShowingMovies");
                console.log(response.data.responseData.nowShowingMovies);
